...
class GlassViewEventHandler extends View.EventHandler {
    ...
    public void handleKeyEvent(View view, long time, int type, int key,
        ...
        QuantumToolkit.runWithoutRenderLock(new Supplier<Object>() {
            @Override
            public Object get() {
    ...
    public int handleDragEnter(View view,
        ...
        TransferMode action;
        try {
            action = QuantumToolkit.runWithoutRenderLock(new Supplier<TransferMode>() {
                @Override
                public TransferMode get() {
        ...
        public Void run() {
            ...
            switch (type) {
                ...
                case ViewEvent.RESIZE: {
                    ...
                    scene.entireSceneNeedsRepaint();
                    QuantumToolkit.runWithRenderLock(new Supplier<Object>() {
                        @Override
                        public Object get() {
