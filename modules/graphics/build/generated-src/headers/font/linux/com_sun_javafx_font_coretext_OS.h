...
#undef com_sun_javafx_font_coretext_OS_kCTWritingDirectionRightToLeft
#define com_sun_javafx_font_coretext_OS_kCTWritingDirectionRightToLeft 1L
/*
...
/*
 * Class:     com_sun_javafx_font_coretext_OS
 * Method:    kCTParagraphStyleAttributeName
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_com_sun_javafx_font_coretext_OS_kCTParagraphStyleAttributeName
  (JNIEnv *, jclass);
...
/*
 * Class:     com_sun_javafx_font_coretext_OS
 * Method:    CTParagraphStyleCreate
 * Signature: (I)J
 */
JNIEXPORT jlong JNICALL Java_com_sun_javafx_font_coretext_OS_CTParagraphStyleCreate
  (JNIEnv *, jclass, jint);
